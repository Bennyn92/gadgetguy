...
if ( ! function_exists( 'storefront_site_title_or_logo' ) ) {
	...
	function storefront_site_title_or_logo( $echo = true ) {
		if ( function_exists( 'the_custom_logo' ) && has_custom_logo() ) {
			...
			$html = '<' . esc_attr( $tag ) . ' class="beta site-title"><a href="' . esc_url( home_url( '/' ) ) . '" rel="home"><img src="http://thecomputerguyde.com/wp-content/themes/storefront-child-theme-master/images/gadgetguylogo_white.svg"></a></' . esc_attr( $tag ) .'>';
